...
local rbot_autosniper_mindamage_2 = gui.Slider(ref, weapon_list[1] .. ".mindmg.2", "Auto Damage Visible", 0, 0, 100);
local rbot_autosniper_mindamage_1 = gui.Slider(ref, weapon_list[1] .. ".mindmg.1", "Auto Damage behind Wall", 0, 0, 100);

local rbot_sniper_mindamage_2 = gui.Slider(ref, weapon_list[2] .. ".mindmg.2", "AWP Damage Visible", 0, 0, 100);
local rbot_sniper_mindamage_1 = gui.Slider(ref, weapon_list[2] .. ".mindmg.1", "AWP Damage behind Wall", 0, 0, 100);


local rbot_scout_mindamage_2 = gui.Slider(ref, weapon_list[3] .. ".mindmg.2", "Scout Damage Visible", 0, 0, 100);
local rbot_scout_mindamage_1 = gui.Slider(ref, weapon_list[3] .. ".mindmg.1", "Scout Damage behind Wall", 0, 0, 100);


local rbot_revolver_mindamage_2 = gui.Slider(ref, weapon_list[4] .. ".mindmg.2", "R8 Damage Visible", 0, 0, 100);
local rbot_revolver_mindamage_1 = gui.Slider(ref, weapon_list[4] .. ".mindmg.1", "R8 Damage behind Wall", 0, 0, 100);


local rbot_pistol_mindamage_2 = gui.Slider(ref, weapon_list[5] .. ".mindmg.2", "Pistols Damage Visible", 0, 0, 100);
local rbot_pistol_mindamage_1 = gui.Slider(ref, weapon_list[5] .. ".mindmg.1", "Pistols Damage behind Wall", 0, 0, 100);


local rbot_rifle_mindamage_2 = gui.Slider(ref, weapon_list[6] .. ".mindmg.2", "Rifles Damage Visible", 0, 0, 100);
local rbot_rifle_mindamage_1 = gui.Slider(ref, weapon_list[6] .. ".mindmg.1", "Rifels Damage behind Wall", 0, 0, 100);
